...
CREATE TABLE `PLANT` (
    ...
    `pref_sun` DECIMAL(5, 2) NOT NULL,
    `pref_air_humidity` DECIMAL(5, 2) NOT NULL,
    `pref_soil_humidity` DECIMAL(5, 2) NOT NULL,
...
CREATE TABLE `SENSOR_DATA` (
    ...
    `humidity_air` DECIMAL(5, 2) NOT NULL,
    `light_intensity` DECIMAL(5, 2) NOT NULL,
    `Humidity_soil` DECIMAL(5, 2) NOT NULL,
    `CO2_amount` DECIMAL(5, 2) NOT NULL,
